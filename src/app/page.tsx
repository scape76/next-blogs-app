...
const technologies = [
  {
    title: "Next.js 13.3",
    content: "App directory, layouts, pages and api routes.",
    image: (
  ...
  {
    title: "React 18",
    content: "Server & Client components, react hooks",
    image: (
      <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current text-blue-700">
  ...
  {
    title: "Database",
    content: "Prisma ORM and postgres database deployed on Supabase",
    image: (
      <svg
        role="img"
        viewBox="0 0 24 24"
        className="h-12 w-12 fill-current text-green-600"
  ...
  {
    title: "Tailwind",
    content: "Components styled using Tailwind CSS",
    image: (
      <svg viewBox="0 0 24 24" className="h-12 w-12 fill-current text-blue-500">
  ...
  },
  {
    ...
    content: "Authentication using NextAuth.js with Google provider",
    image: (
      <svg
        viewBox="0 0 24 24"
        fill="url(#grad1)"
